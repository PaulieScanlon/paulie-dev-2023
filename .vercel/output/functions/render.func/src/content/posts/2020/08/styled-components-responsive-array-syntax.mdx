...
<Tweet id='https://twitter.com/peduarte/status/1295998559117074432' />
...
// app.js
<MrButton
  backgroundColor={['hotpink', 'mouve', 'purple']}
  width={['100%', '50%', 'auto']}
>
  Click Me
</MrButton>
...
<CodeSandbox id='/Styled Components-responsive-array-syntax-3qxu3' />
