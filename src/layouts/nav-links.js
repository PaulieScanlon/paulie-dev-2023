...
// - `type: 'link'` renders a single top-level link.
// - `type: 'group'` renders a dropdown trigger whose `items` are revealed in a
//   disclosure panel (desktop) / accordion (mobile).
// Icons are the same 24x24 path data used elsewhere; `stroke: false` => filled.
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        title: "Ghosts",
        link: "/ghosts/",
        icon: "M11.98,1.1c-4.69,0.01-8.5,3.82-8.5,8.51v11.86c0,0.63,0.76,0.95,1.21,0.5l1.63-1.67l2.34,2.38c0.28,0.28,0.73,0.28,1,0L12,20.31l2.34,2.38c0.28,0.28,0.73,0.28,1,0l2.34-2.38l1.63,1.67c0.45,0.45,1.21,0.13,1.21-0.5V9.69C20.51,5,16.68,1.1,11.98,1.1z M8.45,12.45c-1.17,0-2.13-0.95-2.13-2.13S7.28,8.2,8.45,8.2s2.13,0.95,2.13,2.13S9.63,12.45,8.45,12.45z M15.55,12.45c-1.17,0-2.13-0.95-2.13-2.13s0.95-2.13,2.13-2.13s2.13,0.95,2.13,2.13S16.72,12.45,15.55,12.45z",
        stroke: false
      },
      {
        title: "Demos",
