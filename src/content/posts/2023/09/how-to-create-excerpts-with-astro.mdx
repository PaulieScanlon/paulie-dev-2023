...
To convert the HTML into something you can use you'll need map over each of the HTML elements in the array, strip out all the opening and closing HTML tags, and return the bit in the middle, the text.
