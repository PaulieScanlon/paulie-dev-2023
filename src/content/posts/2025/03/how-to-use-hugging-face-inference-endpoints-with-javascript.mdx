...
In this post, I'll give you a quick intro into Hugging Face [Inference Endpoints](https://huggingface.co/inference-endpoints/dedicated) and how to use the [@huggingface/inference](https://www.npmjs.com/package/@huggingface/inference) JavaScript SDK.
