...
tags: [Gatsby, React, TypeScript, JavaScript, Theme UI, Serverless Functions, Google Analytics]
date: 2021-08-18
...
<Tweet id="https://twitter.com/GatsbyJS/status/1427709225497726982" />

... which may or may not be a name I came up with 😏

<Tweet id="https://twitter.com/pauliescanlon/status/1397215365105602562?s=21" />
...
Stay tuned for more updates on this post or follow me on Twitter: [@PaulieScanlon](https://x.com/P121129E)
...
<Tweet client:load tweetLink="https://x.com/P121129E/status/1428096625394790401?s=20" />
...
<AstroImage
  width="768"
  height="480"
  alt="WIP design for Groovy Analytics"
  url="https://res.cloudinary.com/www-paulie-dev/image/upload/v1629357089/paulie.dev/2021/08/teaser-update-2_raue2s.jpg"
/>
