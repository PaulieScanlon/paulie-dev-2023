---
type: post
title: 'Using Gatsby Serverless Functions as an abstracted API'
tags: [React, Gatsby, Gatsby Serverless Functions, JavaScript, Gatsby Plugins]
date: 2021-06-11
author: Paul Scanlon
...
To use Gatsby Serverless Functions have a read of the
[Getting Started docs](https://www.gatsbyjs.com/docs/reference/functions/getting-started/) but i'll break down the steps
you'll probably need to use Gatsby Serverless Functions anyway
...
<Tweet id='https://twitter.com/jsumnersmith/status/1403333241604653056' />
...
i'm using Gatsby Serverless Functions in an abstracted and potentially easily incrementally adoptable way. -- jeez what
a sentence! 🕺
