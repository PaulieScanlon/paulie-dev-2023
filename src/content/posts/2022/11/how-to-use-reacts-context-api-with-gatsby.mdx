          ...
          return (
            <button onClick={handleNav}>
              ...
              >
                <path
                  d={`${
                    isNavOpen ? 'M5.47 5.47a.75.75...' : 'M3 6.75A.75.75...'
                  }`}
                />
              </svg>
            </button>
...
<Image
  ...
  src='https://res.cloudinary.com/www-paulie-dev/image/upload/v1667229790/paulie.dev/2022/11/context-api-embedded-1_iuyrka.jpg'
/>
