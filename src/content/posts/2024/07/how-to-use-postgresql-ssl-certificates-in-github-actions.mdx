...
In this post i'll explain a scenario where I couldn't use either of the above methods, because my repository was public and my PostgreSQL connection was running as part of a GitHub Action.
...
## How to covert an SSL certificate to base64 string
...
## How to add SSL certificate to GitHub Secrets
