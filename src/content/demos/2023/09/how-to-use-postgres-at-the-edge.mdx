...
tags: [Next.js, React, React Query, Tailwind, Neon, Edge Functions, three.js, react-three-fiber]
date: 2023-09-19
author: Paul Scanlon
featuredImage: https://res.cloudinary.com/www-paulie-dev/image/upload/v1696458956/paulie.dev/2023/09/social-preview-ping-thing-page_stfkti.jpg
---
...
[Ping Thing](https://neon.tech/ping-thing) visualizes the journey your request makes from the Edge Function to the Database. It's a simple concept but it's something I know is often misunderstood.

<Cta href='https://neon.tech/ping-thing'>Visit Ping Thing</Cta>
...
In the case of [Ping Thing](https://neon.tech/ping-thing) I've deployed the database to AWS `us-east-1`, which is located in North Virginia USA.
