...
<CtaExternal href='https://cockroachdb-edge-locations.vercel.app/'>Visit Edge</CtaExternal>
...
<AstroImage
  width='768'
  height='480'
  alt='Edge - full screen globe'
  url='https://res.cloudinary.com/www-paulie-dev/image/upload/v1679405341/paulie.dev/2023/03/edge-demo-full-screen_qd4o9u.jpg'
/>
...
<AstroImage
  width='768'
  height='480'
  alt='Vercel Single Region Serverless Function'
  url='https://res.cloudinary.com/www-paulie-dev/image/upload/v1679413308/paulie.dev/2023/03/edge-demo-serverless_nvhedb.jpg'
/>
...
<AstroImage
  width='768'
  height='480'
  alt='AWS Multi-Region Lambda Function'
  url='https://res.cloudinary.com/www-paulie-dev/image/upload/v1679413308/paulie.dev/2023/03/edge-demo-lambda_ptykp6.jpg'
/>

You can see the distances data travels by toggling between the single region Vercel Serverless Function and the
multi-region AWS Lambda Functions — spoiler alert, distances will likely be shorter when routed through AWS.
