...
"2025/04/neon-local-docker-compose-javascript.mdx": {
	id: "2025/04/neon-local-docker-compose-javascript.mdx";
  slug: "2025/04/neon-local-docker-compose-javascript";
  body: string;
  collection: "articles";
  data: any
} & { render(): Render[".mdx"] };
...
"2025/12/announcing-mastra-server-adapters.mdx": {
	id: "2025/12/announcing-mastra-server-adapters.mdx";
  slug: "2025/12/announcing-mastra-server-adapters";
  body: string;
  collection: "articles";
  data: any
} & { render(): Render[".mdx"] };
...
"2026/04/introducing-browser-support.mdx": {
	id: "2026/04/introducing-browser-support.mdx";
  slug: "2026/04/introducing-browser-support";
  body: string;
  collection: "articles";
  data: any
} & { render(): Render[".mdx"] };
"2026/04/introducing-channels.mdx": {
	id: "2026/04/introducing-channels.mdx";
  slug: "2026/04/introducing-channels";
  body: string;
  collection: "articles";
  data: any
} & { render(): Render[".mdx"] };
"2026/04/introducing-remote-filesystems.mdx": {
	id: "2026/04/introducing-remote-filesystems.mdx";
  slug: "2026/04/introducing-remote-filesystems";
  body: string;
  collection: "articles";
  data: any
} & { render(): Render[".mdx"] };
"2026/04/lsp-inspection-for-mastra-workspaces.mdx": {
	id: "2026/04/lsp-inspection-for-mastra-workspaces.mdx";
  slug: "2026/04/lsp-inspection-for-mastra-workspaces";
  body: string;
  collection: "articles";
  data: any
} & { render(): Render[".mdx"] };
"2026/05/introducing-agent-to-agent-support.mdx": {
	id: "2026/05/introducing-agent-to-agent-support.mdx";
  slug: "2026/05/introducing-agent-to-agent-support";
  body: string;
  collection: "articles";
  data: any
} & { render(): Render[".mdx"] };
"2026/05/introducing-background-tasks.mdx": {
	id: "2026/05/introducing-background-tasks.mdx";
  slug: "2026/05/introducing-background-tasks";
  body: string;
  collection: "articles";
  data: any
} & { render(): Render[".mdx"] };
"2026/05/introducing-clickhouse-support.mdx": {
	id: "2026/05/introducing-clickhouse-support.mdx";
  slug: "2026/05/introducing-clickhouse-support";
  body: string;
  collection: "articles";
  data: any
} & { render(): Render[".mdx"] };
"2026/05/introducing-response-caching.mdx": {
	id: "2026/05/introducing-response-caching.mdx";
  slug: "2026/05/introducing-response-caching";
  body: string;
  collection: "articles";
  data: any
} & { render(): Render[".mdx"] };
"2026/05/introducing-temporal-workflows.mdx": {
	id: "2026/05/introducing-temporal-workflows.mdx";
  slug: "2026/05/introducing-temporal-workflows";
  body: string;
  collection: "articles";
  data: any
} & { render(): Render[".mdx"] };
"2026/05/upgraded-mastra-cli.mdx": {
	id: "2026/05/upgraded-mastra-cli.mdx";
  slug: "2026/05/upgraded-mastra-cli";
  body: string;
  collection: "articles";
  data: any
} & { render(): Render[".mdx"] };
"2026/06/introducing-agent-client-protocol.mdx": {
	id: "2026/06/introducing-agent-client-protocol.mdx";
  slug: "2026/06/introducing-agent-client-protocol";
  body: string;
  collection: "articles";
  data: any
} & { render(): Render[".mdx"] };
"2026/06/introducing-code-mode.mdx": {
	id: "2026/06/introducing-code-mode.mdx";
  slug: "2026/06/introducing-code-mode";
  body: string;
  collection: "articles";
  data: any
} & { render(): Render[".mdx"] };
...
"2026/06/introducing-task-lists.mdx": {
	id: "2026/06/introducing-task-lists.mdx";
  slug: "2026/06/introducing-task-lists";
  body: string;
  collection: "articles";
  data: any
} & { render(): Render[".mdx"] };
"2026/06/mastra-cli-actions.mdx": {
	id: "2026/06/mastra-cli-actions.mdx";
  slug: "2026/06/mastra-cli-actions";
  body: string;
  collection: "articles";
  data: any
} & { render(): Render[".mdx"] };
...
"2025/04/neon-local.mdx": {
	id: "2025/04/neon-local.mdx";
  slug: "2025/04/neon-local";
  body: string;
  collection: "docs";
  data: any
} & { render(): Render[".mdx"] };
"2026/05/github-actions-pr-description.mdx": {
	id: "2026/05/github-actions-pr-description.mdx";
  slug: "2026/05/github-actions-pr-description";
  body: string;
  collection: "docs";
  data: any
} & { render(): Render[".mdx"] };
"2026/05/slack-assistant.mdx": {
	id: "2026/05/slack-assistant.mdx";
  slug: "2026/05/slack-assistant";
  body: string;
  collection: "docs";
  data: any
} & { render(): Render[".mdx"] };
...
"2025/04/announcing-neon-snapshots-a-smoother-path-to-recovery.mdx": {
	id: "2025/04/announcing-neon-snapshots-a-smoother-path-to-recovery.mdx";
  slug: "2025/04/announcing-neon-snapshots-a-smoother-path-to-recovery";
  body: string;
  collection: "ghosts";
  data: any
} & { render(): Render[".mdx"] };
"2025/04/make-yourself-at-home-with-neon-local.mdx": {
	id: "2025/04/make-yourself-at-home-with-neon-local.mdx";
  slug: "2025/04/make-yourself-at-home-with-neon-local";
  body: string;
  collection: "ghosts";
  data: any
} & { render(): Render[".mdx"] };
"2026/01/annoucing-mastra-1.mdx": {
	id: "2026/01/annoucing-mastra-1.mdx";
  slug: "2026/01/annoucing-mastra-1";
  body: string;
  collection: "ghosts";
  data: any
} & { render(): Render[".mdx"] };
"2026/02/announcing-datasets-in-mastra-studio.mdx": {
	id: "2026/02/announcing-datasets-in-mastra-studio.mdx";
  slug: "2026/02/announcing-datasets-in-mastra-studio";
  body: string;
  collection: "ghosts";
  data: any
} & { render(): Render[".mdx"] };
"2026/02/announcing-mastra-code.mdx": {
	id: "2026/02/announcing-mastra-code.mdx";
  slug: "2026/02/announcing-mastra-code";
  body: string;
  collection: "ghosts";
  data: any
} & { render(): Render[".mdx"] };
...
"2026/03/change-run-and-compare-with-experiments-in-mastra-studio.mdx": {
	id: "2026/03/change-run-and-compare-with-experiments-in-mastra-studio.mdx";
  slug: "2026/03/change-run-and-compare-with-experiments-in-mastra-studio";
  body: string;
  collection: "ghosts";
  data: any
} & { render(): Render[".mdx"] };
"2026/04/announcing-agent-editor.mdx": {
	id: "2026/04/announcing-agent-editor.mdx";
  slug: "2026/04/announcing-agent-editor";
  body: string;
  collection: "ghosts";
  data: any
} & { render(): Render[".mdx"] };
"2026/04/announcing-mastra-platform.mdx": {
	id: "2026/04/announcing-mastra-platform.mdx";
  slug: "2026/04/announcing-mastra-platform";
  body: string;
  collection: "ghosts";
  data: any
} & { render(): Render[".mdx"] };
"2026/04/announcing-studio-metrics.mdx": {
	id: "2026/04/announcing-studio-metrics.mdx";
  slug: "2026/04/announcing-studio-metrics";
  body: string;
  collection: "ghosts";
  data: any
} & { render(): Render[".mdx"] };
"2026/05/announcing-agent-builder.mdx": {
	id: "2026/05/announcing-agent-builder.mdx";
  slug: "2026/05/announcing-agent-builder";
  body: string;
  collection: "ghosts";
  data: any
} & { render(): Render[".mdx"] };
"2026/06/announcing-agent-harness.mdx": {
	id: "2026/06/announcing-agent-harness.mdx";
  slug: "2026/06/announcing-agent-harness";
  body: string;
  collection: "ghosts";
  data: any
} & { render(): Render[".mdx"] };
